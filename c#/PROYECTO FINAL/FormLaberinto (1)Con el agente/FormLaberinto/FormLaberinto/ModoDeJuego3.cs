...
namespace FormLaberinto
{
    public partial class ModoDeJuego3 : Form
    {
        ...
        private void btnJugar_Click(object sender, EventArgs e)
        {
            ...
            recorrido2 = TheMaze2.recorrerProfundidad();
        ...
        public string compararTiempo()
        {
            ...
            {
                return "ha ganado " + "Computer 2 : " + intervalo1 + "\n Computer 1: " + intervalo2;
            }
        }
        ...
        private void TiempoRecorrido2_Tick(object sender, EventArgs e)
        {
            ...
            {
                g2.FillRectangle(Brushes.Gold, (float)recorrido2[cantDeCeldas2].X + 2.5f, (float)recorrido2[cantDeCeldas2].Y + 2.5f, tamañoCeldaD, tamañoCeldaD);
        ...
        private void TiempoRecorrido1_Tick(object sender, EventArgs e)
        {
            ...
            {
                g1.FillRectangle(Brushes.Gold, (float)recorrido1[cantDeCeldas1].X + 2.5f, (float)recorrido1[cantDeCeldas1].Y + 2.5f, tamañoCeldaD, tamañoCeldaD);
