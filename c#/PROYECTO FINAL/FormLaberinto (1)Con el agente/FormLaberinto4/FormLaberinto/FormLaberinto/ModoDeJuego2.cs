...
namespace FormLaberinto
{
    public partial class ModoDeJuego2 : Form
    {
        ...
        public List<System.Windows.Point> recorrido;
        ...
        private void btnJugar_Click(object sender, EventArgs e)
        {
            ...
            timer1.Enabled = true;
            timer2.Enabled = true;
            recorrido = TheMaze.recorrerProfundidad();//recorrido en profundidad devuelve una list
        ...
        private void TiempoRecorrido_Tick(object sender, EventArgs e)
        {
            ...
            {
                g2.FillRectangle(Brushes.Gold, (float)recorrido[cantDeCeldas].X * Cell.kCellSize + Cell.kPadding + 2.5f, (float)recorrido[cantDeCeldas].Y * Cell.kCellSize + Cell.kPadding + 2.5f, tamañoCeldaD, tamañoCeldaD);
